...
return (
  <div className="max-w-[800px] mx-3 sm:mx-auto  p-6 bg-[#e1e5ec] dark:bg-zinc-800/80 border border-slate-200 dark:border-zinc-700/60 rounded-2xl shadow-sm space-y-5 transition-colors duration-300">
