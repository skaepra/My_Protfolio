...
const StoreScreen = () => {
  return (
    <div className="bg-gray-50 dark:bg-zinc-900 transition-colors duration-200 min-h-screen p-4 sm:p-8">
      <div className="max-w-7xl mx-auto">
        {/* العنوان */}
        <div className="mb-10 text-center max-w-2xl mx-auto space-y-3">
          <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight ">
            Latest Products & <span className="text-[#325bb3] dark:text-red-500">Store</span>
          </h2>
